...
function postToSocialMedia(classList) {
  ...
  if (classList.contains("twitter")) {
    const url = `https://github.com/venkat7903`;
    window.open(url);
  } else if (classList.contains("linkedin")) {
    const url = `https://www.linkedin.com/in/venkats7903`;
    window.open(url);
  } else if (classList.contains("whatsapp")) {
    window.open(`https://www.instagram.com/rj_raja1729?igsh=OGkwcGFzNzlvaGY3`);
  }
}
